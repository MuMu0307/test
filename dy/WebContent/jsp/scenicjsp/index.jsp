...
<div><%--start--%>
    <script>
        ...
        var constant = m.constant('constRef',[["登录","注册","个人信息","管理用户","搜索","注销","修改密码"],//topOperation
            ["景区列表","门票预定","我的订单","我的足迹","我的景区","新增景区","用户管理"],//left nav bar
        ...
        <div class="row" >
            <div class="col-xs-2" style="border: 1px solid #d9edf7;padding: 2px;" ng-controller="leftcontroller">
                <ul class="nav nav-pills nav-stacked">
                    ...
                    <li ng-if="1 == 2" ng-class="{active:activeStatus == 3}"><a style="cursor: pointer;" ng-click="rightDiv(constRef[1][3])" ng-bind="constRef[1][3]"></a></li>
                    <li ng-if="idOfLoger != 8" ng-class="{active:activeStatus == 4}"><a style="cursor: pointer;" ng-click="rightDiv(constRef[1][4])" ng-bind="constRef[1][4]"></a></li>
                    <li ng-if="idOfLoger == 8" ng-class="{active:activeStatus == 5}"><a style="cursor: pointer;" ng-click="rightDiv(constRef[1][5])" ng-bind="constRef[1][5]"></a></li>
                    <li ng-if="idOfLoger == 8" ng-class="{active:activeStatus == 6}"><a style="cursor: pointer;" ng-click="rightDiv(constRef[1][6])" ng-bind="constRef[1][6]"></a></li>
                </ul>
            </div>
            ...
            <div class="ng-hide" ng-show="nav == 3">
                <%@ include file="jspf/myfoot.jspf" %>
            </div>
            <div class="ng-hide" ng-show="nav == 4">
                <%@ include file="jspf/myScenic.jspf" %>
            </div>
            <div class="ng-hide" ng-show="nav == 5">
                <%@ include file="jspf/addScenic.jspf" %>
            </div>
